...
public class OnlineFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        bMostrarClanes= root.findViewById(R.id.mostrarclanes);

        bMostrarClanes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogBuscarClan dialogoBuscarClan = new DialogBuscarClan();
                dialogoBuscarClan.show(getActivity().getSupportFragmentManager(), "DialogoPerfil");
            }
        });
